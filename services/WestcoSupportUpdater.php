...
/*
|--------------------------------------------------------------------------
| Main Westco Support Plugin Updater Class
|--------------------------------------------------------------------------
|
| This is the main class that checks for updates from GitHub for the
| 95 West Support plugin, and preforms the updates by jumping into
| wordpresses Plugin Transients causing the plugin update prompts.
|
*/

class WestcoSupportUpdater {
